...
class CatatanModel extends Model
{
    ...
    {
         //query         
         $query="SELECT tb_perjalanan.id_perjalanan, tb_perjalanan.id_user, tb_perjalanan.lokasi, tb_perjalanan.tanggal, tb_perjalanan.waktu, tb_perjalanan.ket, tb_user.nama, tb_user.hp FROM tb_perjalanan JOIN tb_user ON tb_user.nik=tb_perjalanan.id_user WHERE tb_perjalanan.id_user='$id_user'";         
