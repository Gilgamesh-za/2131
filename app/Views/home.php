      ...
      <div class="col-lg-6 d-flex flex-column justify-content-center">
        ...
        <div data-aos="fade-up" data-aos-delay="600">
          <div class="text-center text-lg-start">
            <a href="#about" class="btn-get-started nav-link scrollto d-inline-flex align-items-center justify-content-center align-self-center">
...
<section id="about" class="about">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      ...
      <p>Tentang Aplikasi,Covid-19 News,Table Perjalanan</p>
    </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
        <div class="box">
          ...
          <h3>Covid-19 News</h3>
          <p>Cari tahu tentang berita terkait kasus covid di negara kita</p>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
        <div class="box">
          ...
          <h3>Table Perjalanan</h3>
          <p>Sebuah table yang berfungsi sebagai catatan perjalanan anda untuk penganggulangan covid-19</p>
